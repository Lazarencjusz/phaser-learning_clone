...
module.exports = {
  ...
  packagerConfig: {
    ...
    asar: true,
    // Set executable name
    executableName: 'Flappy Bird - Michał Wojas',
  ...
  makers: [
    {
      ...
      config: {
        name: 'electron-phaser-typescript-webpack',
      },
    },
    {
  ...
  plugins: [
    {
      ...
      config: {
        ...
        mainConfig: path.join(rootDir, 'tools/webpack/webpack.electron.js'),
        // Renderer process webpack configuration
        renderer: {
          // Configuration file path
          config: path.join(rootDir, 'tools/webpack/webpack.app.js'),
          ...
          entryPoints: [
            {
              ...
              html: path.join(rootDir, 'src/app/index.html'),
              // Renderer
              js: path.join(rootDir, 'src/app/index.ts'),
              // Main Window
              // Preload
              preload: {
                js: path.join(rootDir, 'src/app/preload.ts'),
              },
            },
          ],
        },
